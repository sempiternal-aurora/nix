...
in
{
    ...
    config = lib.mkIf cfg.enable {
        ...
        wayland.windowManager.sway = {
            enable = true;
            checkConfig = false; # Temporary build fix
            package = pkgs.swayfx;
            config = {
                modifier = modifier;
                terminal = terminal;
...
expand_wildcards = false
        ...
        programs.waybar = {
            ...
            settings.mainBar = {
                ...
                modules-right = [ "idle_inhibitor" "pulseaudio" "pulseaudio#2" "backlight" "backlight#2" 
                                    "battery" "battery#2" "tray" "clock" "clock#2" "sway/language" ];
